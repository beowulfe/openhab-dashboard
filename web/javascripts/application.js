...
(function() {
  ...
  Batman.config.pathPrefix = path;

  Batman.config.viewPrefix = path + "/views";

  Dashing.on('ready', function() {
    var contentWidth;
    Dashing.widget_margins || (Dashing.widget_margins = [5, 5]);
    Dashing.widget_base_dimensions || (Dashing.widget_base_dimensions = [145, 157]);
    Dashing.numColumns || (Dashing.numColumns = 7);
    ...
    return Batman.setImmediate(function() {
      ...
      if (/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent)) {
        return $('.gridster > ul').each(function() {
          return $(this).gridster().data('gridster').draggable().disable();
        });
      }
    });
  });
...
(function() {
  ...
  Dashing.ClickableWidget = (function(superClass) {
    extend(ClickableWidget, superClass);

    function ClickableWidget() {
      ClickableWidget.__super__.constructor.apply(this, arguments);
      $(this.node).on('click', (function(_this) {
        return function(evt) {
          return _this.handleClick(evt);
        };
      })(this));
      $(this.node).on('touchstart', (function(_this) {
        return function(evt) {
          return _this.handleTouchStart(evt);
        };
      })(this));
      $(this.node).on('touchmove', (function(_this) {
        return function(evt) {
          return _this.handleTouchMove(evt);
        };
      })(this));
      $(this.node).on('touchend', (function(_this) {
        return function(evt) {
    ...
    ClickableWidget.prototype.handleClick = function(evt) {
      return this.onClick(evt);
    };

    ClickableWidget.prototype.handleTouchStart = function(evt) {
      evt.preventDefault();
      return this.onTouchStart(evt);
    };

    ClickableWidget.prototype.handleTouchMove = function(evt) {
      return this.onTouchMove(evt);
    };

    ClickableWidget.prototype.handleTouchEnd = function(evt) {
      this.onTouchEnd(evt);
      return this.onClick(evt);
    };

    ClickableWidget.prototype.onClick = function(evt) {};

    ClickableWidget.prototype.onTouchStart = function(evt) {};

    ClickableWidget.prototype.onTouchMove = function(evt) {};

    ClickableWidget.prototype.onTouchEnd = function(evt) {};
...
(function() {
  ...
  moveWithTransition = function(elements, arg, done) {
    var end, moveToEnd, moveToStart, offset, origTransitions, start, timeInSeconds, transition;
    transition = arg.transition, start = arg.start, end = arg.end, timeInSeconds = arg.timeInSeconds, offset = arg.offset;
    ...
    moveToStart = function() {
      ...
      for (index = i = 0, len = elements.length; i < len; index = ++i) {
        ...
        results.push($el.css(isFunction(start) ? start($el, index + offset) : start));
      }
      return results;
    };
    moveToEnd = function() {
      var $el, el, i, index, len;
      for (index = i = 0, len = elements.length; i < len; index = ++i) {
        el = elements[index];
        $el = $(el);
        $el.css({
  ...
  showHideDashboard = function(visible, stagger, $dashboard, transitions, done) {
    ...
    if (transitions.transitionFunction) {
      ...
      transitionFunction = function($dashboard, arg, fnDone) {
        var originalLocations, widgets;
        widgets = arg.widgets, originalLocations = arg.originalLocations;
      ...
      transitionFunction = function($dashboard, arg, fnDone) {
        var i, index, len, originalLocations, singleWidgetFn, widget, widgets;
        widgets = arg.widgets, originalLocations = arg.originalLocations;
  ...
  pickMember = function(object, allowedMembers) {
    var answer, functionArray, i, index, len, member, memberName;
    ...
    if (allowedMembers != null) {
      ...
      for (i = 0, len = allowedMembers.length; i < len; i++) {
        memberName = allowedMembers[i];
  ...
  Dashing.cycleDashboardsNow = (function() {
    ...
    return function(options) {
      var $dashboards, boardnumber, doneCount, doneFn, fastTransition, hideFunction, oldVisibleIndex, showNewDashboard, stagger, transitiontype;
      if (options == null) {
        options = {};
      }
      ...
      stagger = options.stagger, fastTransition = options.fastTransition, boardnumber = options.boardnumber, transitiontype = options.transitiontype;
      stagger = !!stagger;
  ...
  Dashing.cycleDashboards = function(options) {
    var $dashboards, cycleFn, startDashboard, timeInSeconds;
    timeInSeconds = options.timeInSeconds != null ? options.timeInSeconds : 20;
    $dashboards = $('.gridster');
    startDashboard = options.page != null ? options.page : 1;
    ...
    $dashboards.each(function(dashboardIndex, dashboard) {
      $(dashboard).toggle(dashboardIndex === (startDashboard - 1));
      return $(dashboard).css({
        "position": "absolute"
      });
    });
    if ((typeof startDashboardParam === "undefined" || startDashboardParam === null) && (timeInSeconds > 0)) {
      cycleFn = function() {
  ...
  Dashing.cycleGridsterLayout = function(positions) {
    var $dashboard, $dashboards, i, index, len, position, results, widget, widgets;
    positions = JSON.parse(positions);
    $dashboards = $(".gridster > ul");
    if (isArray(positions) && ($dashboards.length === positions.length)) {
      Dashing.customGridsterLayout = true;
      results = [];
      for (index = i = 0, len = positions.length; i < len; index = ++i) {
        ...
        results.push((function() {
          var j, len1, results1;
          results1 = [];
          for (index = j = 0, len1 = widgets.length; j < len1; index = ++j) {
            widget = widgets[index];
            $(widget).attr('data-row', position[index].row);
            results1.push($(widget).attr('data-col', position[index].col));
          }
          return results1;
        })());
      }
  ...
  sleep(0.1, function() {
    Dashing.getWidgetPositions = function() {
      var dashboard, dashboardPositions, i, len, ref;
      dashboardPositions = [];
      ref = $(".gridster > ul");
...
(function() {
  Dashing.gridsterLayout = function(positions) {
    var i, index, len, results, widget, widgets;
    Dashing.customGridsterLayout = true;
    ...
    for (index = i = 0, len = widgets.length; i < len; index = ++i) {
      ...
      results.push($(widget).attr('data-col', positions[index].col));
    }
    return results;
  };
...
(function() {
  ...
  Dashing.BigImage = (function(superClass) {
    var draw, endsWith, getImageSize, makeVideo, resizeImage, sleep;

    extend(BigImage, superClass);

    function BigImage() {
      return BigImage.__super__.constructor.apply(this, arguments);
    }
    ...
    resizeImage = function($img, maxWidth, maxHeight, maximize) {
      var delta_x, delta_y, height, width;
      width = $img.width();
      height = $img.height();
      delta_x = width - maxWidth;
      delta_y = height - maxHeight;
      if (delta_x <= delta_y) {
        return $img.css("height", maxHeight);
      } else {
        return $img.css("width", maxWidth);
      }
    };

    getImageSize = function($img, done) {
      var img, loadedHandler;
      loadedHandler = function() {
        $img.off('load', loadedHandler);
        return done($img.width(), $img.height());
      };
      img = $img[0];
      if (!img.complete) {
        return $img.on('load', loadedHandler);
      } else {
        return sleep(0, loadedHandler);
      }
    };

    sleep = function(timeInMs, fn) {
      return setTimeout(fn, timeInMs);
    };

    BigImage.prototype.ready = function() {
      var container;
      container = $(this.node).parent();
      this.maxWidth = (Dashing.widget_base_dimensions[0] * container.data("sizex")) + Dashing.widget_margins[0] * 2 * (container.data("sizex") - 1);
      this.maxHeight = Dashing.widget_base_dimensions[1] * container.data("sizey");
      return draw(this);
    };

    BigImage.prototype.onData = function(data) {
    ...
    makeVideo = function(url, type) {
      return $('<video preload="auto" autoplay="autoplay" muted="muted" loop="loop" webkit-playsinline> <source src="' + url + '" type="' + type + '"> </video>');
    };

    draw = function(self) {
      var $el, $img, imageUrl, needResize;
      $el = $(self.node);
      needResize = false;
      $el.find('img').remove();
      ...
      if (endsWith(imageUrl, ".mp4")) {
        ...
        imageUrl = imageUrl.slice(0, -5) + ".mp4";
        $img = makeVideo(imageUrl, 'video/mp4');
      } else {
        needResize = true;
      ...
      $el.append($img);
      if (needResize) {
        return getImageSize($img, (function(_this) {
          return function(width, height) {
            return resizeImage($img, self.maxWidth, self.maxHeight, self.get('max'));
          };
        })(this));
      }
    };
...
(function() {
  ...
  Dashing.Cameras = (function(superClass) {
    var endsWith, getImageSize, resizeImage, sleep;

    extend(Cameras, superClass);

    function Cameras() {
      return Cameras.__super__.constructor.apply(this, arguments);
    }
...
(function() {
  ...
  Dashing.Changepage = (function(superClass) {
    ...
    Changepage.prototype.ready = function() {};

    Changepage.prototype.onData = function(data) {};

    Changepage.prototype.onClick = function(node, event) {
      return Dashing.cycleDashboardsNow({
        boardnumber: this.get('page'),
        stagger: this.get('stagger'),
        fastTransition: this.get('fasttransition'),
...
(function() {
  ...
  Dashing.Clock = (function(superClass) {
    ...
    Clock.prototype.startTime = function() {
      ...
      this.set('time', this.formatHours(h) + ":" + m + " " + this.formatAmPm(h));
      return this.set('date', today.toLocaleDateString('en-GB', options));
    };
    ...
    Clock.prototype.formatAmPm = function(h) {
      if (h >= 12) {
        return "PM";
      } else {
        return "AM";
    ...
    Clock.prototype.formatHours = function(h) {
      if (h > 12) {
        return h - 12;
      } else if (h === 0) {
        return 12;
...
(function() {
  ...
  Dashing.Iframe = (function(superClass) {
    ...
    Iframe.prototype.ready = function() {
      return $(this.node).find(".iframe").attr('src', this.get('src'));
    };

    Iframe.prototype.onData = function(data) {
      return $(this.node).find(".iframe").attr('src', data.src);
    };
...
(function() {
  ...
  Dashing.Number = (function(superClass) {
    ...
    Number.prototype.onClick = function(node, event) {
      return $.post('/smartthings/dispatch', {
...
(function() {
  ...
  Dashing.Ohalert = (function(superClass) {
    extend(Ohalert, superClass);

    function Ohalert() {
      Ohalert.__super__.constructor.apply(this, arguments);
      this.queryState();
    }

    Ohalert.accessor('state', {
      get: function() {
        var ref;
        return (ref = this._state) != null ? ref : "Unknown";
      },
      set: function(key, value) {
        return this._state = value.toLowerCase();
      }
    });

    Ohalert.accessor('isAlertState', function() {
      return this.get('state') === 'open' || this.get('state') === 'on';
    });

    Ohalert.accessor('icon', {
      get: function() {
        if (this.get('isAlertState')) {
          return 'expand';
        } else {
          return 'compress';
        }
    ...
    Ohalert.accessor('icon-style', function() {
      if (this.get('isAlertState')) {
        return 'icon-open';
      } else {
        return 'icon-closed';
    ...
    Ohalert.prototype.queryState = function() {
      return $.get('/openhab/dispatch', {
        widgetId: this.get('id'),
        ...
        return function(data) {
          ...
          return _this.set('state', json.state);
        };
      })(this));
    };

    Ohalert.prototype.ready = function() {
      return this.setCSSClass(this.get('state'));
    };

    Ohalert.prototype.onData = function(data) {
      this.setCSSClass(this.get('state'));
      return $(this.node).fadeOut().fadeIn();
    };

    Ohalert.prototype.setCSSClass = function(status) {
      if (status) {
        $(this.get('node')).attr('class', function(i, c) {
          return c.replace(/\bstate-\S+/g, '');
        });
        return $(this.node).addClass("state-" + status);
      }
    };
...
(function() {
  ...
  Dashing.Ohcontact = (function(superClass) {
    extend(Ohcontact, superClass);

    function Ohcontact() {
      Ohcontact.__super__.constructor.apply(this, arguments);
      this.queryState();
    }

    Ohcontact.accessor('state', {
      get: function() {
        var ref;
        return (ref = this._state) != null ? ref : "Unknown";
      },
    ...
    Ohcontact.accessor('icon', {
      get: function() {
        if (this.get('state') === 'open' || this.get('state') === 'on') {
          return 'expand';
        } else {
          return 'compress';
        }
    ...
    Ohcontact.accessor('icon-style', function() {
      if (this.get('state') === 'open' || this.get('state') === 'on') {
        return 'icon-open';
      } else {
        return 'icon-closed';
    ...
    Ohcontact.prototype.queryState = function() {
      return $.get('/openhab/dispatch', {
        widgetId: this.get('id'),
        deviceId: this.get('device'),
        deviceType: 'contact'
        ...
        return function(data) {
          var json;
          json = JSON.parse(data);
          return _this.set('state', json.state.toLowerCase());
        };
      })(this));
    };

    Ohcontact.prototype.ready = function() {};

    Ohcontact.prototype.onData = function(data) {
      return this.set('state', this.get('state').toLowerCase());
    };
...
(function() {
  ...
  Dashing.Ohdimmer = (function(superClass) {
    extend(Ohdimmer, superClass);

    function Ohdimmer() {
      Ohdimmer.__super__.constructor.apply(this, arguments);
      this.queryState();
    }

    Ohdimmer.accessor('state', {
      get: function() {
        var ref;
        return (ref = this._state) != null ? ref : '0';
      },
      set: function(key, value) {
        return this._state = value;
      }
    ...
    Ohdimmer.accessor('icon', {
      get: function() {
        if (this['icon']) {
          return this['icon'];
        } else {
          if (parseInt(this.get('state')) > 0) {
            return this.get('iconon');
          } else {
            return this.get('iconoff');
          }
        }
      },
      set: Batman.Property.defaultAccessor.set
    ...
    Ohdimmer.accessor('iconon', {
      get: function() {
        var ref;
        return (ref = this['iconon']) != null ? ref : 'circle';
      },
      set: Batman.Property.defaultAccessor.set
    });

    Ohdimmer.accessor('iconoff', {
      get: function() {
        var ref;
        return (ref = this['iconoff']) != null ? ref : 'circle-thin';
      },
      set: Batman.Property.defaultAccessor.set
    });

    Ohdimmer.accessor('icon-style', function() {
      if (parseInt(this.get('state')) > 0) {
        return 'dimmer-icon-on';
      } else {
        return 'dimmer-icon-off';
      }
    });

    Ohdimmer.prototype.plusLevel = function() {
      var newLevel;
      newLevel = parseInt(this.get('state')) + 10;
      if (newLevel > 100) {
        newLevel = 100;
      } else if (newLevel < 0) {
        newLevel = 0;
      }
      this.set('state', newLevel);
      return this.get('state');
    };

    Ohdimmer.prototype.minusLevel = function() {
      var newLevel;
      newLevel = parseInt(this.get('state')) - 10;
      if (newLevel > 100) {
        newLevel = 100;
    ...
    Ohdimmer.prototype.levelUp = function() {
      var newLevel;
      newLevel = this.plusLevel();
      return $.post('/openhab/dispatch', {
        deviceId: this.get('device'),
        command: newLevel
      });
    };

    Ohdimmer.prototype.levelDown = function() {
      var newLevel;
      newLevel = this.minusLevel();
      return $.post('/openhab/dispatch', {
        deviceId: this.get('device'),
        command: newLevel
      });
    ...
    Ohdimmer.prototype.toggleState = function() {
      var newState;
      newState = this.get('state') > 0 ? '0' : '100';
      this.set('state', newState);
      return newState;
    };

    Ohdimmer.prototype.queryState = function() {
      return $.get('/openhab/dispatch', {
        widgetId: this.get('id'),
        deviceId: this.get('device'),
        deviceType: 'switch'
    ...
    Ohdimmer.prototype.postState = function() {
      var newState;
      newState = this.toggleState();
      return $.post('/openhab/dispatch', {
        deviceId: this.get('device'),
        command: newState
      });
    ...
    Ohdimmer.prototype.ready = function() {};

    Ohdimmer.prototype.onData = function(data) {
      debugger;
    };

    Ohdimmer.prototype.onClick = function(event) {
...
(function() {
  ...
  Dashing.Ohheating = (function(superClass) {
    extend(Ohheating, superClass);

    function Ohheating() {
      Ohheating.__super__.constructor.apply(this, arguments);
      this.queryState();
      Ohbridge.subscribe(this.get('devicetarget'), (function(_this) {
        return function(data) {
          return _this.set('target', data);
        };
      })(this));
    }

    Ohheating.accessor('state', {
      get: function() {
        var ref;
        return (ref = this._state) != null ? ref : "Unknown";
      },
    ...
    Ohheating.accessor('temperature', {
      get: function() {
        if (this._temperature) {
          return parseFloat(this._temperature).toFixed(1);
        } else {
          return 0;
        }
      },
    ...
    Ohheating.accessor('target', {
      get: function() {
        if (this._target) {
          return parseFloat(this._target).toFixed(1);
        } else {
          return 0;
        }
      },
    ...
    Ohheating.accessor('target-style', function() {
      if (this.get('temperature') === this.get('target')) {
        console.log("style: steady");
        return 'heating-steady';
      } else if (this.get('temperature') < this.get('target')) {
    ...
    Ohheating.prototype.queryState = function() {
      Ohbridge.queryState(this.get('device'), (function(_this) {
        return function(data) {
          return _this.set('temperature', data);
        };
      })(this));
      return Ohbridge.queryState(this.get('devicetarget'), (function(_this) {
        return function(data) {
          return _this.set('target', data);
        };
      })(this));
    ...
    Ohheating.prototype.ready = function() {};

    Ohheating.prototype.onData = function(data) {
      return this.set('temperature', data);
    };
...
(function() {
  ...
  Dashing.Ohhumidity = (function(superClass) {
    extend(Ohhumidity, superClass);

    function Ohhumidity() {
      Ohhumidity.__super__.constructor.apply(this, arguments);
      this.queryState();
    }

    Ohhumidity.accessor('value', {
      get: function() {
        if (this._value) {
    ...
    Ohhumidity.prototype.queryState = function() {
      return $.get('/openhab/dispatch', {
        widgetId: this.get('id'),
        deviceId: this.get('device'),
        deviceType: 'humidity'
        ...
        return function(data) {
          var json;
          json = JSON.parse(data);
          return _this.set('value', json.state);
        };
      })(this));
    };

    Ohhumidity.prototype.ready = function() {};

    Ohhumidity.prototype.onData = function(data) {};
...
(function() {
  ...
  Dashing.Ohmeter = (function(superClass) {
    extend(Ohmeter, superClass);

    function Ohmeter() {
      Ohmeter.__super__.constructor.apply(this, arguments);
      this.queryState();
      this.observe('state', function(value) {
        return $(this.node).find(".ohmeter").val(value).trigger('change');
      });
    }

    Ohmeter.accessor('state', Dashing.AnimatedValue);

    Ohmeter.prototype.queryState = function() {
      return $.get('/openhab/dispatch', {
        widgetId: this.get('id'),
        deviceId: this.get('device'),
        deviceType: 'power'
    ...
    Ohmeter.prototype.ready = function() {
      var ohmeter;
      ohmeter = $(this.node).find(".ohmeter");
      ohmeter.attr("data-bgcolor", ohmeter.css("background-color"));
      ohmeter.attr("data-fgcolor", ohmeter.css("color"));
      return ohmeter.knob();
    };

    Ohmeter.prototype.onData = function(data) {};
...
(function() {
  ...
  Dashing.Ohmotion = (function(superClass) {
    extend(Ohmotion, superClass);

    function Ohmotion() {
      Ohmotion.__super__.constructor.apply(this, arguments);
      this.queryState();
    }

    Ohmotion.accessor('state', {
      get: function() {
        var ref;
        return (ref = this._state) != null ? ref : "Unknown";
      },
    ...
    Ohmotion.accessor('icon-style', function() {
      if (this.get('state') === 'active') {
        return 'icon-active';
      } else {
    ...
    Ohmotion.prototype.queryState = function() {
      return $.get('/openhab/dispatch', {
        widgetId: this.get('id'),
        deviceId: this.get('device'),
        deviceType: 'motion'
    ...
    Ohmotion.prototype.ready = function() {};

    Ohmotion.prototype.onData = function(data) {};
...
(function() {
  ...
  Dashing.Ohpresence = (function(superClass) {
    extend(Ohpresence, superClass);

    function Ohpresence() {
      Ohpresence.__super__.constructor.apply(this, arguments);
      this.queryState();
    }

    Ohpresence.accessor('state', {
      get: function() {
        var ref;
        return (ref = this._state) != null ? ref : "Unknown";
      },
    ...
    Ohpresence.accessor('icon', {
      get: function() {
        if (this.get('state') === 'present') {
          return 'user';
        } else {
          return 'times';
        }
    ...
    Ohpresence.accessor('icon-style', function() {
      if (this.get('state') === 'present') {
        return 'icon-present';
      } else {
        return 'icon-absent';
    ...
    Ohpresence.prototype.queryState = function() {
      return $.get('/openhab/dispatch', {
        widgetId: this.get('id'),
        deviceId: this.get('device'),
        deviceType: 'presence'
    ...
    Ohpresence.prototype.ready = function() {};

    Ohpresence.prototype.onData = function(data) {};
...
(function() {
  ...
  Dashing.Ohrollershutter = (function(superClass) {
    extend(Ohrollershutter, superClass);

    function Ohrollershutter() {
      Ohrollershutter.__super__.constructor.apply(this, arguments);
      this.queryState();
    }

    Ohrollershutter.accessor('state', {
      get: function() {
        var ref;
        return (ref = this._state) != null ? ref : '0';
      },
    ...
    Ohrollershutter.accessor('iconon', {
      get: function() {
        var ref;
        return (ref = this['iconon']) != null ? ref : 'circle';
      },
    ...
    Ohrollershutter.accessor('iconoff', {
      get: function() {
        var ref;
        return (ref = this['iconoff']) != null ? ref : 'circle-thin';
      },
    ...
    Ohrollershutter.accessor('icon-style', function() {
      if (parseInt(this.get('state')) > 0) {
        return 'rollershutter-icon-on';
      } else {
        return 'rollershutter-icon-off';
      }
    });

    Ohrollershutter.prototype.plusLevel = function() {
      var newLevel;
      newLevel = parseInt(this.get('state')) - 10;
      if (newLevel > 100) {
        newLevel = 100;
    ...
    Ohrollershutter.prototype.minusLevel = function() {
      var newLevel;
      newLevel = parseInt(this.get('state')) + 10;
      if (newLevel > 100) {
        newLevel = 100;
    ...
    Ohrollershutter.prototype.levelUp = function() {
      var newLevel;
      newLevel = this.plusLevel();
      return $.post('/openhab/dispatch', {
        deviceId: this.get('device'),
    ...
    Ohrollershutter.prototype.levelDown = function() {
      var newLevel;
      newLevel = this.minusLevel();
      return $.post('/openhab/dispatch', {
        deviceId: this.get('device'),
    ...
    Ohrollershutter.prototype.toggleState = function() {
      var newState;
      newState = this.get('state') > 0 ? '0' : '80';
      this.set('state', newState);
      return newState;
    };

    Ohrollershutter.prototype.queryState = function() {
      return $.get('/openhab/dispatch', {
        widgetId: this.get('id'),
        deviceId: this.get('device'),
        deviceType: 'switch'
    ...
    Ohrollershutter.prototype.postState = function() {
      var newState;
      newState = this.toggleState();
      return $.post('/openhab/dispatch', {
        deviceId: this.get('device'),
    ...
    Ohrollershutter.prototype.ready = function() {};

    Ohrollershutter.prototype.onData = function(data) {
      debugger;
    };

    Ohrollershutter.prototype.onClick = function(event) {
      if (event.target.id === "level-down") {
        return this.levelDown();
      } else if (event.target.id === "level-up") {
        return this.levelUp();
...
(function() {
  ...
  Dashing.Ohroomstatus = (function(superClass) {
    extend(Ohroomstatus, superClass);

    function Ohroomstatus() {
      Ohroomstatus.__super__.constructor.apply(this, arguments);
      this.queryState();
    }

    Ohroomstatus.accessor('state', {
      get: function() {
        var ref;
        return (ref = this._state) != null ? ref : "Unknown";
      },
    ...
    Ohroomstatus.accessor('temperature', {
      get: function() {
        if (this._temperature) {
          return Math.floor(this._temperature);
        } else {
          return 0;
        }
      },
    ...
    Ohroomstatus.accessor('icon-style', function() {
      if (this.get('state').toUpperCase() === 'OPEN' || this.get('state') === 'ON') {
        return 'icon-open';
      } else {
        return 'icon-closed';
      }
    ...
    Ohroomstatus.prototype.queryState = function() {
      return $.get('/openhab/dispatch', {
        widgetId: this.get('id'),
        deviceId: this.get('device'),
        deviceType: 'contact'
    ...
    Ohroomstatus.prototype.ready = function() {};

    Ohroomstatus.prototype.onData = function(data) {};
...
(function() {
  ...
  Dashing.Ohswitch = (function(superClass) {
    extend(Ohswitch, superClass);

    function Ohswitch() {
      Ohswitch.__super__.constructor.apply(this, arguments);
      this.queryState();
    }

    Ohswitch.accessor('state', {
      get: function() {
        var ref;
        return (ref = this._state) != null ? ref : 'OFF';
      },
      set: function(key, value) {
        return this._state = value;
      }
    ...
    Ohswitch.accessor('icon-style', function() {
      if (this.get('state') === 'ON') {
        return 'switch-icon-on';
      } else {
        return 'switch-icon-off';
      }
    });

    Ohswitch.prototype.toggleState = function() {
      var newState;
      newState = this.get('state') === 'ON' ? 'OFF' : 'ON';
      this.set('state', newState);
      return newState;
    };

    Ohswitch.prototype.queryState = function() {
      return Ohbridge.queryState(this.get('device'), (function(_this) {
        return function(data) {
          _this.set('state', data);
          return _this.onData(data);
        };
      })(this));
    };

    Ohswitch.prototype.postState = function() {
      var newState;
      newState = this.toggleState();
      return Ohbridge.setState(this.get('device'), newState);
    };

    Ohswitch.prototype.ready = function() {};

    Ohswitch.prototype.onClick = function(event) {
      return this.postState();
    };

    Ohswitch.prototype.onData = function(data) {
      if (data == parseInt(data, 10)) {
        return this.set('state', data > 0 ? "ON" : "OFF");
      }
    };
...
(function() {
  ...
  Dashing.Ohtemp = (function(superClass) {
    extend(Ohtemp, superClass);

    function Ohtemp() {
      Ohtemp.__super__.constructor.apply(this, arguments);
      this.queryState();
    }

    Ohtemp.accessor('state', {
      get: function() {
        if (this._state) {
          return parseFloat(this._state).toFixed(1);
        } else {
          return 0;
        }
      },
    ...
    Ohtemp.prototype.queryState = function() {
      return $.get('/openhab/dispatch', {
        widgetId: this.get('id'),
        deviceId: this.get('device'),
    ...
    Ohtemp.prototype.ready = function() {};

    Ohtemp.prototype.onData = function(data) {};
...
(function() {
  ...
  Dashing.Ohtext = (function(superClass) {
    extend(Ohtext, superClass);

    function Ohtext() {
      Ohtext.__super__.constructor.apply(this, arguments);
      this.queryState();
    }

    Ohtext.accessor('state', {
      get: function() {
        var ref;
        return (ref = this._state) != null ? ref : "Unknown";
      },
    ...
    Ohtext.prototype.queryState = function() {
      return $.get('/openhab/dispatch', {
        widgetId: this.get('id'),
        deviceId: this.get('device'),
        deviceType: 'text'
    ...
    Ohtext.prototype.ready = function() {};

    Ohtext.prototype.onData = function(data) {};
...
(function() {
  ...
  Dashing.Ohvolume = (function(superClass) {
    extend(Ohvolume, superClass);

    function Ohvolume() {
      Ohvolume.__super__.constructor.apply(this, arguments);
      this.queryState();
    }

    Ohvolume.accessor('state', {
      get: function() {
        var ref;
        return (ref = this._state) != null ? ref : '0';
      },
    ...
    Ohvolume.accessor('icon-style', function() {
      if (parseInt(this.get('state')) > 0) {
        return 'volume-icon-on';
      } else {
        return 'volume-icon-off';
      }
    });

    Ohvolume.prototype.plusLevel = function() {
      var newLevel;
      newLevel = parseInt(this.get('state')) + 5;
      if (newLevel > 100) {
        newLevel = 100;
      } else if (newLevel < 0) {
        newLevel = 0;
    ...
    Ohvolume.prototype.minusLevel = function() {
      var newLevel;
      newLevel = parseInt(this.get('state')) - 5;
      if (newLevel > 100) {
        newLevel = 100;
    ...
    Ohvolume.prototype.levelUp = function() {
      var newLevel;
      newLevel = this.plusLevel();
      return $.post('/openhab/dispatch', {
        deviceId: this.get('device'),
    ...
    Ohvolume.prototype.levelDown = function() {
      var newLevel;
      newLevel = this.minusLevel();
      return $.post('/openhab/dispatch', {
        deviceId: this.get('device'),
    ...
    Ohvolume.prototype.toggleState = function() {
      var newState;
      newState = this.get('state') > 0 ? '0' : '20';
      this.set('state', newState);
      return newState;
    };

    Ohvolume.prototype.queryState = function() {
      return $.get('/openhab/dispatch', {
        widgetId: this.get('id'),
        deviceId: this.get('device'),
        deviceType: 'switch'
    ...
    Ohvolume.prototype.postState = function() {
      var newState;
      newState = this.toggleState();
      return $.post('/openhab/dispatch', {
        deviceId: this.get('device'),
    ...
    Ohvolume.prototype.ready = function() {};

    Ohvolume.prototype.onData = function(data) {
      debugger;
    };

    Ohvolume.prototype.onClick = function(event) {
      if (event.target.id === "level-down") {
        return this.levelDown();
      } else if (event.target.id === "level-up") {
        return this.levelUp();
...
(function() {
  ...
  Dashing.Ohweather = (function(superClass) {
    extend(Ohweather, superClass);

    Ohweather.group = "weather";
    ...
    function Ohweather() {
      var fn, key, ref, value;
      Ohweather.__super__.constructor.apply(this, arguments);
      this._icons = {
      ...
      this.reverseMap = {};
      ref = Dashing.Ohweather.mapping;
      fn = (function(_this) {
        return function(prop) {
          return Ohbridge.subscribe(value, function(data) {
            return _this.set(prop, data);
          });
        };
      })(this);
      for (key in ref) {
    ...
    Ohweather.accessor('climacon', function() {
      return new Batman.TerminalAccessible((function(_this) {
        return function(attr) {
          return _this._icons[attr];
        };
      })(this));
    });

    Ohweather.accessor('now_temp', {
      get: function() {
        if (this._temp) {
          return Math.floor(this._temp);
        } else {
          return 0;
        }
      },
    ...
    Ohweather.accessor('icon', function() {
      if (this.get('weather_code') != null) {
        return this.get('weather_code').replace(/\-/g, "").replace(/day/g, "");
      }
    });

    Ohweather.accessor('tomorrow_icon', function() {
      if (this.get('tomorrow_weather_code') != null) {
        return this.get('tomorrow_weather_code').replace(/\-/g, "").replace(/day/g, "");
      }
    });

    Ohweather.prototype.queryState = function() {
      return Ohbridge.queryGroup(Dashing.Ohweather.group, (function(_this) {
        return function(data) {
          ...
          for (i = 0, len = ref.length; i < len; i++) {
            member = ref[i];
            if (_this.reverseMap[member.name] != null) {
              results.push(_this.set(_this.reverseMap[member.name], member.state));
            } else {
              results.push(void 0);
            }
          }
    ...
    Ohweather.prototype.ready = function() {};

    Ohweather.prototype.onData = function(data) {};
...
(function() {
  ...
  Dashing.Ohweathertoday = (function(superClass) {
    extend(Ohweathertoday, superClass);

    function Ohweathertoday() {
      var fn, key, ref, value;
      Ohweathertoday.__super__.constructor.apply(this, arguments);
      this._icons = {
        chanceflurries: '&#xe036',
        chancerain: '&#xe009',
        chancesleet: '&#xe003',
    ...
    Ohweathertoday.accessor('climacon', function() {
      return new Batman.TerminalAccessible((function(_this) {
        return function(attr) {
          return _this._icons[attr];
        };
    ...
    Ohweathertoday.accessor('icon', function() {
      if (this.get('weatherCode') != null) {
        return this.get('weatherCode').replace(/\-/g, "").replace(/day/g, "");
      }
    });

    Ohweathertoday.accessor('now_temp', {
      get: function() {
        if (this._temp) {
          return Math.floor(this._temp);
        } else {
    ...
    Ohweathertoday.prototype.queryState = function() {
      return Ohbridge.queryGroup(Dashing.Ohweather.group, (function(_this) {
        return function(data) {
          var i, len, member, ref, results;
          ref = data.members;
    ...
    Ohweathertoday.prototype.ready = function() {};

    Ohweathertoday.prototype.onData = function(data) {};

    return Ohweathertoday;
...
(function() {
  ...
  Dashing.Reload = (function(superClass) {
    extend(Reload, superClass);

    function Reload() {
      return Reload.__super__.constructor.apply(this, arguments);
    }

    Reload.prototype.ready = function() {};

    Reload.prototype.onData = function(data) {};

    Reload.prototype.onClick = function(event) {
      return Dashing.fire('reload');
    };
...
(function() {
  ...
  Dashing.Stlock = (function(superClass) {
    extend(Stlock, superClass);

    function Stlock() {
      Stlock.__super__.constructor.apply(this, arguments);
      this.queryState();
    }

    Stlock.accessor('state', {
      get: function() {
        var ref;
        return (ref = this._state) != null ? ref : 'unlocked';
      },
      set: function(key, value) {
        return this._state = value;
      }
    ...
    Stlock.accessor('icon', {
      get: function() {
        if (this.get('state') === 'unlocked') {
          return 'unlock-alt';
        } else {
          return 'lock';
        }
    ...
    Stlock.accessor('icon-style', function() {
    ...
    Stlock.prototype.toggleState = function() {
      var newState;
      newState = this.get('state') === 'locked' ? 'unlock' : 'lock';
      this.set('state', newState);
      return newState;
    };

    Stlock.prototype.queryState = function() {
      return $.get('/smartthings/dispatch', {
        widgetId: this.get('id'),
        deviceType: 'lock',
        deviceId: this.get('device')
      }, (function(_this) {
    ...
    Stlock.prototype.postState = function() {
      var newState;
      newState = this.toggleState();
      return $.post('/smartthings/dispatch', {
        deviceType: 'lock',
    ...
    Stlock.prototype.ready = function() {};

    Stlock.prototype.onData = function(data) {};

    Stlock.prototype.onClick = function(event) {
      return this.postState();
    };
...
(function() {
  ...
  Dashing.Stmode = (function(superClass) {
    extend(Stmode, superClass);

    function Stmode() {
      Stmode.__super__.constructor.apply(this, arguments);
      this.queryState();
    }

    Stmode.accessor('mode', {
      get: function() {
        var ref;
        return (ref = this._mode) != null ? ref : "Unknown";
      },
      set: function(key, value) {
    ...
    Stmode.prototype.queryState = function() {
      return $.get('/smartthings/dispatch', {
        widgetId: this.get('id'),
        deviceType: 'mode'
      }, (function(_this) {
        return function(data) {
          var json;
          json = JSON.parse(data);
          return _this.set('mode', json.mode);
        };
      })(this));
    };

    Stmode.prototype.ready = function() {};

    Stmode.prototype.onData = function(data) {};
...
(function() {
  ...
  Dashing.Stmodechange = (function(superClass) {
    extend(Stmodechange, superClass);

    function Stmodechange() {
      this.changeModeDelayed = bind(this.changeModeDelayed, this);
      Stmodechange.__super__.constructor.apply(this, arguments);
      this.queryState();
    }

    Stmodechange.accessor('icon', {
      get: function() {
        var ref;
        return (ref = this['icon']) != null ? ref : 'tag';
      },
      set: Batman.Property.defaultAccessor.set
    });

    Stmodechange.accessor('icon-style', function() {
      if (this.isModeSet()) {
        return 'icon-active';
      } else {
        return 'icon-inactive';
    ...
    Stmodechange.accessor('countdown', {
      get: function() {
        var ref;
        return (ref = this._countdown) != null ? ref : 0;
      },
      set: function(key, value) {
    ...
    Stmodechange.accessor('timer', {
      get: function() {
        var ref;
        return (ref = this._timer) != null ? ref : 0;
      },
      set: function(key, value) {
    ...
    Stmodechange.prototype.showTimer = function() {
      $(this.node).find('.icon').hide();
      return $(this.node).find('.timer').show();
    };

    Stmodechange.prototype.showIcon = function() {
      $(this.node).find('.timer').hide();
      return $(this.node).find('.icon').show();
    };

    Stmodechange.prototype.isModeSet = function() {
      return this.get('mode') === this.get('changemode');
    };

    Stmodechange.prototype.queryState = function() {
      return $.get('/smartthings/dispatch', {
        widgetId: this.get('id'),
        deviceType: 'mode'
      }, (function(_this) {
    ...
    Stmodechange.prototype.postModeState = function() {
      var oldMode;
      oldMode = this.get('mode');
      this.set('mode', this.get('changemode'));
      return $.post('/smartthings/dispatch', {
        deviceType: 'mode',
        mode: this.get('changemode')
      }, (function(_this) {
        return function(data) {
          var json;
          json = JSON.parse(data);
          if (json.error !== 0) {
            return _this.set('mode', oldModeM);
          }
        };
      })(this));
    };

    Stmodechange.prototype.postPhraseState = function() {
      return $.post('/smartthings/dispatch', {
        deviceType: 'phrase',
        phrase: this.get('phrase')
      }, (function(_this) {
        return function(data) {
          return _this.queryState();
        };
      })(this));
    };

    Stmodechange.prototype.ready = function() {
      return this.showIcon();
    };

    Stmodechange.prototype.onData = function(data) {};

    Stmodechange.prototype.changeModeDelayed = function() {
      if (this.get('timer') <= 0) {
        this.showIcon();
        if (this.get('phrase')) {
          this.postPhraseState();
        } else {
          this.postModeState();
        }
        ...
        return this._timeout = setTimeout(this.changeModeDelayed, 1000);
      }
    };

    Stmodechange.prototype.onClick = function(event) {
      if (!this._timeout && !this.isModeSet()) {
        this.set('timer', this.get('countdown'));
        return this.changeModeDelayed();
      }
    };
